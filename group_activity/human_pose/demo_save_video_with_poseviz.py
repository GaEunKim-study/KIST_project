# -*- coding: utf-8 -*-
"""demo_save_video_with_poseviz.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IP7WOWO8tHtzABiVCD20Xc7V7Tezd612
"""
...
import sys
sys.path.append("/home/sj/Git/Project/metrabs/src")
...
def predict_video(predict_fn, video_path, viz):
    ...
    if FLAGS.write_video:
        ...
        viz.start_new_video(out_video_path, fps=30)

    camera = poseviz.cameralib.Camera.from_fov(FLAGS.fov, frame_batch_ds.element_spec.shape[1:3])
